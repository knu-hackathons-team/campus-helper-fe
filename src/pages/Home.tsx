      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">실시간 요청</h2>
            <p className="text-gray-600 dark:text-gray-300">
              급한 도움이 필요할 때 주변 학생들과 빠르게 연결됩니다
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">위치 기반</h2>
            <p className="text-gray-600 dark:text-gray-300">
              현재 위치 주변의 요청들을 쉽게 확인할 수 있습니다
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">안전한 거래</h2>
            <p className="text-gray-600 dark:text-gray-300">
